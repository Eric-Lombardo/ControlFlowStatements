...
//    If all parameters are valid, the method needs to calculate the number of buckets and return it.
    ...
    public static void main(String[] args) {
        System.out.println(getBucketCount(-3.4, 2.1, 1.5, 2)); // return -1 since the width parameter is invalid
        System.out.println(getBucketCount(3.4, 2.1, 1.5, 2)); // return 3 since the wall area is 7.14, a single bucket can cover an area of 1.5 and Bob has 2 extra buckets home.
        System.out.println(getBucketCount(2.75, 3.25, 2.5, 1)); // return 3 since the wall area is 8.9375, a single bucket can cover an area of 2.5 and Bob has 1 extra bucket at home.
        System.out.println("==========================================");
        System.out.println(getBucketCount(-3.4, 2.1, 1.5)); // return -1 since the width parameter is invalid
        System.out.println(getBucketCount(3.4, 2.1, 1.5)); // return 5 since the wall area is 7.14, and a single bucket can cover an area of 1.5.
        System.out.println(getBucketCount(7.25, 4.3, 2.35)); // return 14 since the wall area is 31.175, and a single bucket can cover an area of 2.35.
        System.out.println("==========================================");
        System.out.println(getBucketCount(3.4, 1.5)); // return 3 since the area is 3.4 and a single bucket can cover an area of 1.5
        System.out.println(getBucketCount(6.26, 2.2)); // return 3 since the wall area is 6.26 and a single bucket can cover an area of 2.2.
        System.out.println(getBucketCount(3.26, 0.75)); // return 5 since the wall area is 3.26, and a single bucket can cover an area of 0.75
    }
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket, int extraBuckets) {
        ...
        double bucketsNeeded = (surfaceArea / areaPerBucket) - extraBuckets;
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket) {
        ...
        double surfaceArea = width * height;
        double bucketsNeeded = surfaceArea / areaPerBucket;
        return (int) Math.ceil(bucketsNeeded);
    }
